...
%
%
  \newtheoremstyle{ido-algorithm}% name of the style to be used
    {1em}% Space above
    {1em}% Space below
    {\normalfont}% Body font
...
\newtheoremstyle{ido-question}% name
  {1em}% Space above (used to be \topsep)
  {1em}% Space below
  {\itshape\normalfont}% Body font
  {}% Indent amount
  {\color{purple}}% Theorem head font
  {}%Punctuation after theorem head
  {0.5em}%Space after theorem head
  {}
